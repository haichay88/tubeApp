...
export interface Schema$Company {
     ...
     * badges. These are stored as full URLs as entered by the user, but only the
     * TLD will be used for the actual verification.
     */
...
export interface Schema$ListLeadsResponse {
    ...
    /**
     * A token to retrieve next page of results. Pass this value in the
     * `ListLeadsRequest.page_token` field in the subsequent call to ListLeads to
...
export interface Schema$User {
     ...
     * preferred account and we use this when a personal account is needed. Can be
     * empty meaning the user has access to no accounts. @OutputOnly
     */
...
export interface Schema$UserProfile {
    ...
    /**
     * If the user has edit access to multiple accounts, the user can choose the
     * preferred account and it is used when a personal account is needed. Can be
     * empty.
     */
...
export declare class Resource$Analytics {
    root: Partners;
    constructor(root: Partners);
    getRoot(): Partners;
    /**
     * partners.analytics.list
     * @desc Lists analytics data for a user's associated company. Should only be
     ...
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$ListAnalyticsResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$ListAnalyticsResponse>, callback?: BodyResponseCallback<Schema$ListAnalyticsResponse>): void;
}
export declare class Resource$Clientmessages {
    root: Partners;
    constructor(root: Partners);
    getRoot(): Partners;
    /**
     ...
     * @return {object} Request object
     */
    log(params: any, options?: MethodOptions): AxiosPromise<Schema$LogMessageResponse>;
    log(params: any, options: MethodOptions | BodyResponseCallback<Schema$LogMessageResponse>, callback?: BodyResponseCallback<Schema$LogMessageResponse>): void;
}
export declare class Resource$Companies {
    root: Partners;
     ...
     * @return {object} Request object
     */
    get(params: any, options?: MethodOptions): AxiosPromise<Schema$GetCompanyResponse>;
    get(params: any, options: MethodOptions | BodyResponseCallback<Schema$GetCompanyResponse>, callback?: BodyResponseCallback<Schema$GetCompanyResponse>): void;
    /**
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$ListCompaniesResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$ListCompaniesResponse>, callback?: BodyResponseCallback<Schema$ListCompaniesResponse>): void;
}
export declare class Resource$Companies$Leads {
    root: Partners;
    constructor(root: Partners);
    getRoot(): Partners;
    /**
     ...
     * @return {object} Request object
     */
    create(params: any, options?: MethodOptions): AxiosPromise<Schema$CreateLeadResponse>;
    create(params: any, options: MethodOptions | BodyResponseCallback<Schema$CreateLeadResponse>, callback?: BodyResponseCallback<Schema$CreateLeadResponse>): void;
}
export declare class Resource$Leads {
    root: Partners;
    constructor(root: Partners);
    getRoot(): Partners;
    /**
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$ListLeadsResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$ListLeadsResponse>, callback?: BodyResponseCallback<Schema$ListLeadsResponse>): void;
}
export declare class Resource$Offers {
    root: Partners;
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$ListOffersResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$ListOffersResponse>, callback?: BodyResponseCallback<Schema$ListOffersResponse>): void;
}
export declare class Resource$Offers$History {
    root: Partners;
    constructor(root: Partners);
    getRoot(): Partners;
    /**
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$ListOffersHistoryResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$ListOffersHistoryResponse>, callback?: BodyResponseCallback<Schema$ListOffersHistoryResponse>): void;
}
export declare class Resource$Userevents {
    root: Partners;
    constructor(root: Partners);
    getRoot(): Partners;
    /**
     ...
     * @return {object} Request object
     */
    log(params: any, options?: MethodOptions): AxiosPromise<Schema$LogUserEventResponse>;
    log(params: any, options: MethodOptions | BodyResponseCallback<Schema$LogUserEventResponse>, callback?: BodyResponseCallback<Schema$LogUserEventResponse>): void;
}
export declare class Resource$Users {
     ...
     * @return {object} Request object
     */
    createCompanyRelation(params: any, options?: MethodOptions): AxiosPromise<Schema$CompanyRelation>;
    createCompanyRelation(params: any, options: MethodOptions | BodyResponseCallback<Schema$CompanyRelation>, callback?: BodyResponseCallback<Schema$CompanyRelation>): void;
    /**
     ...
     * @return {object} Request object
     */
    deleteCompanyRelation(params: any, options?: MethodOptions): AxiosPromise<Schema$Empty>;
    deleteCompanyRelation(params: any, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback?: BodyResponseCallback<Schema$Empty>): void;
    /**
     * partners.users.get
     * @desc Gets a user.
     ...
     * @return {object} Request object
     */
    updateProfile(params: any, options?: MethodOptions): AxiosPromise<Schema$UserProfile>;
    updateProfile(params: any, options: MethodOptions | BodyResponseCallback<Schema$UserProfile>, callback?: BodyResponseCallback<Schema$UserProfile>): void;
}
export declare class Resource$Userstates {
    root: Partners;
    constructor(root: Partners);
    getRoot(): Partners;
    /**
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$ListUserStatesResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$ListUserStatesResponse>, callback?: BodyResponseCallback<Schema$ListUserStatesResponse>): void;
}
export declare class Resource$V2 {
    root: Partners;
    constructor(root: Partners);
    getRoot(): Partners;
    /**
     ...
     * @return {object} Request object
     */
    getPartnersstatus(params: any, options?: MethodOptions): AxiosPromise<Schema$GetPartnersStatusResponse>;
    getPartnersstatus(params: any, options: MethodOptions | BodyResponseCallback<Schema$GetPartnersStatusResponse>, callback?: BodyResponseCallback<Schema$GetPartnersStatusResponse>): void;
    /**
     ...
     * @return {object} Request object
     */
    updateCompanies(params: any, options?: MethodOptions): AxiosPromise<Schema$Company>;
    updateCompanies(params: any, options: MethodOptions | BodyResponseCallback<Schema$Company>, callback?: BodyResponseCallback<Schema$Company>): void;
    /**
    ...
    updateLeads(params: any, options: MethodOptions | BodyResponseCallback<Schema$Lead>, callback?: BodyResponseCallback<Schema$Lead>): void;
}
