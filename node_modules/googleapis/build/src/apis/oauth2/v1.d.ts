...
export declare class Oauth2 {
     ...
     */
    getCertForOpenIdConnect(params: any, options?: MethodOptions): AxiosPromise<Schema$X509>;
    getCertForOpenIdConnect(params: any, options: MethodOptions | BodyResponseCallback<Schema$X509>, callback?: BodyResponseCallback<Schema$X509>): void;
    /**
     ...
     * @return {object} Request object
     */
    getCertForOpenIdConnectRaw(params: any, options?: MethodOptions): AxiosPromise<Schema$Raw>;
    getCertForOpenIdConnectRaw(params: any, options: MethodOptions | BodyResponseCallback<Schema$Raw>, callback?: BodyResponseCallback<Schema$Raw>): void;
    /**
     * oauth2.getRobotJwk
    ...
    getRobotJwk(params: any, options: MethodOptions | BodyResponseCallback<Schema$Jwk>, callback?: BodyResponseCallback<Schema$Jwk>): void;
    /**
     ...
     * @return {object} Request object
     */
    getRobotMetadataRaw(params: any, options?: MethodOptions): AxiosPromise<Schema$Raw>;
    getRobotMetadataRaw(params: any, options: MethodOptions | BodyResponseCallback<Schema$Raw>, callback?: BodyResponseCallback<Schema$Raw>): void;
    /**
     ...
     * @return {object} Request object
     */
    getRobotMetadataX509(params: any, options?: MethodOptions): AxiosPromise<Schema$X509>;
    getRobotMetadataX509(params: any, options: MethodOptions | BodyResponseCallback<Schema$X509>, callback?: BodyResponseCallback<Schema$X509>): void;
    /**
     * oauth2.tokeninfo
     * @desc Get token info
