...
export interface Schema$SpeechRecognitionAlternative {
     ...
     * any of the results. The default of 0.0 is a sentinel value indicating
...
export declare class Resource$Speech {
     ...
     * @return {object} Request object
     */
    asyncrecognize(params: any, options?: MethodOptions): AxiosPromise<Schema$Operation>;
    asyncrecognize(params: any, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback?: BodyResponseCallback<Schema$Operation>): void;
    /**
     ...
     * @return {object} Request object
     */
    syncrecognize(params: any, options?: MethodOptions): AxiosPromise<Schema$SyncRecognizeResponse>;
    syncrecognize(params: any, options: MethodOptions | BodyResponseCallback<Schema$SyncRecognizeResponse>, callback?: BodyResponseCallback<Schema$SyncRecognizeResponse>): void;
}
