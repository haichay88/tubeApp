 ...
 */
export declare class Videointelligence {
...
export interface Schema$GoogleCloudVideointelligenceV1beta1_AnnotateVideoProgress {
     ...
     */
    annotationProgress: Schema$GoogleCloudVideointelligenceV1beta1_VideoAnnotationProgress[];
}
/**
...
export interface Schema$GoogleCloudVideointelligenceV1beta1_AnnotateVideoResponse {
     ...
     */
    annotationResults: Schema$GoogleCloudVideointelligenceV1beta1_VideoAnnotationResults[];
}
/**
 * Label annotation.
 */
...
export interface Schema$GoogleCloudVideointelligenceV1beta1_VideoAnnotationResults {
     ...
     */
    labelAnnotations: Schema$GoogleCloudVideointelligenceV1beta1_LabelAnnotation[];
    /**
     * Safe search annotations.
     */
    safeSearchAnnotations: Schema$GoogleCloudVideointelligenceV1beta1_SafeSearchAnnotation[];
    /**
...
export interface Schema$GoogleCloudVideointelligenceV1p1beta1_FaceDetectionFrame {
     ...
     */
    attributes: Schema$GoogleCloudVideointelligenceV1p1beta1_FaceDetectionAttribute[];
    /**
     * Time-offset, relative to the beginning of the video, corresponding to the
     * video frame for this location.
     */
...
export declare class Resource$Videos {
     ...
     */
    annotate(params: any, options?: MethodOptions): AxiosPromise<Schema$GoogleLongrunning_Operation>;
    annotate(params: any, options: MethodOptions | BodyResponseCallback<Schema$GoogleLongrunning_Operation>, callback?: BodyResponseCallback<Schema$GoogleLongrunning_Operation>): void;
}
