...
export declare class Resource$Projects$Traces {
    ...
    batchWrite(params: any, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback?: BodyResponseCallback<Schema$Empty>): void;
}
export declare class Resource$Projects$Traces$Spans {
    root: Cloudtrace;
    constructor(root: Cloudtrace);
    getRoot(): Cloudtrace;
    /**
    ...
    createSpan(params: any, options: MethodOptions | BodyResponseCallback<Schema$Span>, callback?: BodyResponseCallback<Schema$Span>): void;
}
