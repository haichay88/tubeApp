...
export declare class Resource$Services {
    ...
    report(params: any, options: MethodOptions | BodyResponseCallback<Schema$ReportResponse>, callback?: BodyResponseCallback<Schema$ReportResponse>): void;
    /**
     ...
     * @return {object} Request object
     */
    startReconciliation(params: any, options?: MethodOptions): AxiosPromise<Schema$StartReconciliationResponse>;
    startReconciliation(params: any, options: MethodOptions | BodyResponseCallback<Schema$StartReconciliationResponse>, callback?: BodyResponseCallback<Schema$StartReconciliationResponse>): void;
}
