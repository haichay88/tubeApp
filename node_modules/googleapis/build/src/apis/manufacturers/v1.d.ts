...
export declare class Resource$Accounts {
    ...
    getRoot(): Manufacturers;
}
export declare class Resource$Accounts$Products {
    root: Manufacturers;
    constructor(root: Manufacturers);
    getRoot(): Manufacturers;
    /**
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$ListProductsResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$ListProductsResponse>, callback?: BodyResponseCallback<Schema$ListProductsResponse>): void;
    /**
    ...
    update(params: any, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback?: BodyResponseCallback<Schema$Empty>): void;
}
