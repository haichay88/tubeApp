...
export declare class Resource$Detections {
    root: Translate;
     ...
     */
    detect(params: any, options?: MethodOptions): AxiosPromise<Schema$DetectionsListResponse>;
    detect(params: any, options: MethodOptions | BodyResponseCallback<Schema$DetectionsListResponse>, callback?: BodyResponseCallback<Schema$DetectionsListResponse>): void;
    /**
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$DetectionsListResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$DetectionsListResponse>, callback?: BodyResponseCallback<Schema$DetectionsListResponse>): void;
}
...
export declare class Resource$Translations {
    root: Translate;
    constructor(root: Translate);
    getRoot(): Translate;
    /**
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$TranslationsListResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$TranslationsListResponse>, callback?: BodyResponseCallback<Schema$TranslationsListResponse>): void;
    /**
     ...
     * @return {object} Request object
     */
    translate(params: any, options?: MethodOptions): AxiosPromise<Schema$TranslationsListResponse>;
    translate(params: any, options: MethodOptions | BodyResponseCallback<Schema$TranslationsListResponse>, callback?: BodyResponseCallback<Schema$TranslationsListResponse>): void;
}
