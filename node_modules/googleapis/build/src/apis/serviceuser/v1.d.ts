 ...
 */
export interface Schema$ListEnabledServicesResponse {
    /**
 ...
 * Management.
 */
export interface Schema$PublishedService {
    /**
 ...
 */
export interface Schema$SearchServicesResponse {
    /**
...
export declare class Resource$Projects$Services {
    root: Serviceuser;
    constructor(root: Serviceuser);
    getRoot(): Serviceuser;
    /**
     ...
     * security leaks.  Operation<response: google.protobuf.Empty>
     ...
     * @desc Enable a service so it can be used with a project. See [Cloud Auth
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$ListEnabledServicesResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$ListEnabledServicesResponse>, callback?: BodyResponseCallback<Schema$ListEnabledServicesResponse>): void;
}
export declare class Resource$Services {
     ...
     * @desc Search available services.  When no filter is specified, returns all
     * accessible services. For authenticated users, also returns all services the
     * calling user has "servicemanagement.services.bind" permission for.
     ...
     * @return {object} Request object
     */
    search(params: any, options?: MethodOptions): AxiosPromise<Schema$SearchServicesResponse>;
    search(params: any, options: MethodOptions | BodyResponseCallback<Schema$SearchServicesResponse>, callback?: BodyResponseCallback<Schema$SearchServicesResponse>): void;
}
