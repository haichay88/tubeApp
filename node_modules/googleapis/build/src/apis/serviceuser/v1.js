...
var Serviceuser = /** @class */ (function () {
    function Serviceuser(options, google) {
        this.root = this;
    ...
    Serviceuser.prototype.getRoot = function () {
        return this.root;
    };
    return Serviceuser;
}());
...
var Resource$Projects$Services = /** @class */ (function () {
    function Resource$Projects$Services(root) {
        this.root = root;
        this.getRoot.bind(this);
    }
    Resource$Projects$Services.prototype.getRoot = function () {
        return this.root;
    };
    Resource$Projects$Services.prototype.disable = function (params, options, callback) {
        ...
        options = options || {};
        var rootUrl = options.rootUrl || 'https://content-serviceuser.googleapis.com/';
        var parameters = {
    ...
    Resource$Projects$Services.prototype.enable = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
    ...
    Resource$Projects$Services.prototype.list = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
...
exports.Resource$Projects$Services = Resource$Projects$Services;
var Resource$Services = /** @class */ (function () {
    ...
    Resource$Services.prototype.search = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
