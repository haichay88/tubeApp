...
export declare class Resource$Pipelines {
    ...
    get(params: any, options: MethodOptions | BodyResponseCallback<Schema$Pipeline>, callback?: BodyResponseCallback<Schema$Pipeline>): void;
    /**
     ...
     * @return {object} Request object
     */
    getControllerConfig(params: any, options?: MethodOptions): AxiosPromise<Schema$ControllerConfig>;
    getControllerConfig(params: any, options: MethodOptions | BodyResponseCallback<Schema$ControllerConfig>, callback?: BodyResponseCallback<Schema$ControllerConfig>): void;
    /**
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$ListPipelinesResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$ListPipelinesResponse>, callback?: BodyResponseCallback<Schema$ListPipelinesResponse>): void;
    /**
     ...
     * pipeline once without saving a copy.  The caller must have READ permission
     * to the project where the pipeline is stored and WRITE permission to the
     * project where the pipeline will be run, as VMs will be created and storage
     * will be used.  If a pipeline operation is still running after 6 days, it
     * will be canceled.
     * @example
     * * // BEFORE RUNNING:
     * // ---------------
     ...
     * @return {object} Request object
     */
    setOperationStatus(params: any, options?: MethodOptions): AxiosPromise<Schema$Empty>;
    setOperationStatus(params: any, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback?: BodyResponseCallback<Schema$Empty>): void;
}
