...
export interface Schema$TestIamPermissionsRequest {
     ...
     * not allowed. Allowed permissions are&amp;#58;  * `genomics.datasets.create`
...
export interface Schema$Transcript {
    ...
    /**
     * The &lt;a
     * href=&quot;http://en.wikipedia.org/wiki/Exon&quot;&gt;exons&lt;/a&gt; that
     * compose this transcript. This field should be unset for genomes where
     * transcript splicing does not occur, for example prokaryotes.  Introns are
     * regions of the transcript that are not included in the spliced RNA product.
     * Though not explicitly modeled here, intron ranges can be deduced; all
     * regions of this transcript that are not exons are introns.  Exonic
     * sequences do not necessarily code for a translational product (amino
...
export interface Schema$VariantCall {
     ...
     * of `[&quot;A&quot;, &quot;C&quot;]`, and the `genotype` was `[2, 1]`, that
     ...
     * not, PL scores are converted to GL scores.  If both are available, PL
     ...
     * importing data from VCF, if the genotype data was phased but no phase set
     * was specified this field will be set to `*`.
     */
    phaseset: string;
}
/**
...
export interface Schema$VariantSet {
     ...
     * GRCh38 reference set and contains a single variant on reference
     * &#39;X&#39;, `referenceBounds` would contain only an entry for &#39;X&#39;,
...
export declare class Resource$Annotations {
    root: Genomics;
     ...
     * this annotation set. For optimal performance, batch positionally adjacent
     ...
     */
    batchCreate(params: any, options?: MethodOptions): AxiosPromise<Schema$BatchCreateAnnotationsResponse>;
    batchCreate(params: any, options: MethodOptions | BodyResponseCallback<Schema$BatchCreateAnnotationsResponse>, callback?: BodyResponseCallback<Schema$BatchCreateAnnotationsResponse>): void;
    /**
    ...
    create(params: any, options: MethodOptions | BodyResponseCallback<Schema$Annotation>, callback?: BodyResponseCallback<Schema$Annotation>): void;
    /**
    ...
    get(params: any, options: MethodOptions | BodyResponseCallback<Schema$Annotation>, callback?: BodyResponseCallback<Schema$Annotation>): void;
    /**
     ...
     * @return {object} Request object
     */
    search(params: any, options?: MethodOptions): AxiosPromise<Schema$SearchAnnotationsResponse>;
    search(params: any, options: MethodOptions | BodyResponseCallback<Schema$SearchAnnotationsResponse>, callback?: BodyResponseCallback<Schema$SearchAnnotationsResponse>): void;
    /**
...
export declare class Resource$Annotationsets {
    root: Genomics;
    constructor(root: Genomics);
    getRoot(): Genomics;
    /**
     ...
     * @return {object} Request object
     */
    create(params: any, options?: MethodOptions): AxiosPromise<Schema$AnnotationSet>;
    create(params: any, options: MethodOptions | BodyResponseCallback<Schema$AnnotationSet>, callback?: BodyResponseCallback<Schema$AnnotationSet>): void;
    /**
     * genomics.annotationsets.delete
     * @desc Deletes an annotation set. Caller must have WRITE permission for the
     * associated annotation set.
     * @example
     * * // BEFORE RUNNING:
     * // ---------------
    ...
    get(params: any, options: MethodOptions | BodyResponseCallback<Schema$AnnotationSet>, callback?: BodyResponseCallback<Schema$AnnotationSet>): void;
    /**
     ...
     * consistent, such that two queries for the same content (regardless of page
     * size) yield annotation sets in the same order across their respective
     * streams of paginated responses. Caller must have READ permission for the
     * queried datasets.
     * @example
     * * // BEFORE RUNNING:
     * // ---------------
     ...
     * @return {object} Request object
     */
    search(params: any, options?: MethodOptions): AxiosPromise<Schema$SearchAnnotationSetsResponse>;
    search(params: any, options: MethodOptions | BodyResponseCallback<Schema$SearchAnnotationSetsResponse>, callback?: BodyResponseCallback<Schema$SearchAnnotationSetsResponse>): void;
    /**
     ...
     * @return {object} Request object
     */
    update(params: any, options?: MethodOptions): AxiosPromise<Schema$AnnotationSet>;
    update(params: any, options: MethodOptions | BodyResponseCallback<Schema$AnnotationSet>, callback?: BodyResponseCallback<Schema$AnnotationSet>): void;
}
export declare class Resource$Callsets {
    root: Genomics;
    constructor(root: Genomics);
    getRoot(): Genomics;
    /**
    ...
    create(params: any, options: MethodOptions | BodyResponseCallback<Schema$CallSet>, callback?: BodyResponseCallback<Schema$CallSet>): void;
    /**
    ...
    get(params: any, options: MethodOptions | BodyResponseCallback<Schema$CallSet>, callback?: BodyResponseCallback<Schema$CallSet>): void;
    /**
    ...
    patch(params: any, options: MethodOptions | BodyResponseCallback<Schema$CallSet>, callback?: BodyResponseCallback<Schema$CallSet>): void;
    /**
     ...
     * @return {object} Request object
     */
    search(params: any, options?: MethodOptions): AxiosPromise<Schema$SearchCallSetsResponse>;
    search(params: any, options: MethodOptions | BodyResponseCallback<Schema$SearchCallSetsResponse>, callback?: BodyResponseCallback<Schema$SearchCallSetsResponse>): void;
}
export declare class Resource$Datasets {
    root: Genomics;
    constructor(root: Genomics);
    getRoot(): Genomics;
    /**
    ...
    create(params: any, options: MethodOptions | BodyResponseCallback<Schema$Dataset>, callback?: BodyResponseCallback<Schema$Dataset>): void;
    /**
    ...
    get(params: any, options: MethodOptions | BodyResponseCallback<Schema$Dataset>, callback?: BodyResponseCallback<Schema$Dataset>): void;
    /**
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$ListDatasetsResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$ListDatasetsResponse>, callback?: BodyResponseCallback<Schema$ListDatasetsResponse>): void;
    /**
    ...
    patch(params: any, options: MethodOptions | BodyResponseCallback<Schema$Dataset>, callback?: BodyResponseCallback<Schema$Dataset>): void;
    /**
    ...
    undelete(params: any, options: MethodOptions | BodyResponseCallback<Schema$Dataset>, callback?: BodyResponseCallback<Schema$Dataset>): void;
}
...
export declare class Resource$Readgroupsets {
    root: Genomics;
    ...
    get(params: any, options: MethodOptions | BodyResponseCallback<Schema$ReadGroupSet>, callback?: BodyResponseCallback<Schema$ReadGroupSet>): void;
    /**
  ...
  * }
   ...
   */
    ...
    patch(params: any, options: MethodOptions | BodyResponseCallback<Schema$ReadGroupSet>, callback?: BodyResponseCallback<Schema$ReadGroupSet>): void;
    /**
     ...
     *       // TODO: Change code below to process each resource in
     * `readGroupSetsPage`: console.log(JSON.stringify(readGroupSetsPage[i], null,
     * 2));
     *     }
     *
     *     if (response.nextPageToken) {
     ...
     * @return {object} Request object
     */
    search(params: any, options?: MethodOptions): AxiosPromise<Schema$SearchReadGroupSetsResponse>;
    search(params: any, options: MethodOptions | BodyResponseCallback<Schema$SearchReadGroupSetsResponse>, callback?: BodyResponseCallback<Schema$SearchReadGroupSetsResponse>): void;
}
export declare class Resource$Readgroupsets$Coveragebuckets {
    root: Genomics;
    constructor(root: Genomics);
    getRoot(): Genomics;
    /**
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$ListCoverageBucketsResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$ListCoverageBucketsResponse>, callback?: BodyResponseCallback<Schema$ListCoverageBucketsResponse>): void;
}
export declare class Resource$Reads {
    root: Genomics;
    constructor(root: Genomics);
    getRoot(): Genomics;
    /**
     ...
     *       // TODO: Change code below to process each resource in
     * `alignmentsPage`: console.log(JSON.stringify(alignmentsPage[i], null, 2));
     *     }
     *
     *     if (response.nextPageToken) {
     *       request.resource.pageToken = response.nextPageToken;
     ...
     * @return {object} Request object
     */
    search(params: any, options?: MethodOptions): AxiosPromise<Schema$SearchReadsResponse>;
    search(params: any, options: MethodOptions | BodyResponseCallback<Schema$SearchReadsResponse>, callback?: BodyResponseCallback<Schema$SearchReadsResponse>): void;
}
export declare class Resource$References {
    root: Genomics;
    ...
    get(params: any, options: MethodOptions | BodyResponseCallback<Schema$Reference>, callback?: BodyResponseCallback<Schema$Reference>): void;
    /**
     ...
     *       // TODO: Change code below to process each resource in
     * `referencesPage`: console.log(JSON.stringify(referencesPage[i], null, 2));
     *     }
     *
     *     if (response.nextPageToken) {
     *       request.resource.pageToken = response.nextPageToken;
     ...
     * @return {object} Request object
     */
    search(params: any, options?: MethodOptions): AxiosPromise<Schema$SearchReferencesResponse>;
    search(params: any, options: MethodOptions | BodyResponseCallback<Schema$SearchReferencesResponse>, callback?: BodyResponseCallback<Schema$SearchReferencesResponse>): void;
}
export declare class Resource$References$Bases {
    root: Genomics;
    constructor(root: Genomics);
    getRoot(): Genomics;
    /**
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$ListBasesResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$ListBasesResponse>, callback?: BodyResponseCallback<Schema$ListBasesResponse>): void;
}
export declare class Resource$Referencesets {
    root: Genomics;
    constructor(root: Genomics);
    getRoot(): Genomics;
    /**
    ...
    get(params: any, options: MethodOptions | BodyResponseCallback<Schema$ReferenceSet>, callback?: BodyResponseCallback<Schema$ReferenceSet>): void;
    /**
     ...
     *       // TODO: Change code below to process each resource in
     * `referenceSetsPage`: console.log(JSON.stringify(referenceSetsPage[i], null,
     * 2));
     *     }
     *
     *     if (response.nextPageToken) {
     ...
     * @return {object} Request object
     */
    search(params: any, options?: MethodOptions): AxiosPromise<Schema$SearchReferenceSetsResponse>;
    search(params: any, options: MethodOptions | BodyResponseCallback<Schema$SearchReferenceSetsResponse>, callback?: BodyResponseCallback<Schema$SearchReferenceSetsResponse>): void;
}
export declare class Resource$Variants {
    root: Genomics;
    constructor(root: Genomics);
    getRoot(): Genomics;
    /**
    ...
    create(params: any, options: MethodOptions | BodyResponseCallback<Schema$Variant>, callback?: BodyResponseCallback<Schema$Variant>): void;
    /**
    ...
    get(params: any, options: MethodOptions | BodyResponseCallback<Schema$Variant>, callback?: BodyResponseCallback<Schema$Variant>): void;
    /**
  ...
  * }
   ...
   */
    ...
    merge(params: any, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback?: BodyResponseCallback<Schema$Empty>): void;
    /**
    ...
    patch(params: any, options: MethodOptions | BodyResponseCallback<Schema$Variant>, callback?: BodyResponseCallback<Schema$Variant>): void;
    /**
     ...
     * @return {object} Request object
     */
    search(params: any, options?: MethodOptions): AxiosPromise<Schema$SearchVariantsResponse>;
    search(params: any, options: MethodOptions | BodyResponseCallback<Schema$SearchVariantsResponse>, callback?: BodyResponseCallback<Schema$SearchVariantsResponse>): void;
}
export declare class Resource$Variantsets {
    root: Genomics;
    constructor(root: Genomics);
    getRoot(): Genomics;
    /**
    ...
    create(params: any, options: MethodOptions | BodyResponseCallback<Schema$VariantSet>, callback?: BodyResponseCallback<Schema$VariantSet>): void;
    /**
     ...
     * set. variantSetId: 'my-variant-set-id',  // TODO: Update placeholder value.
     *
     *     resource: {
     *       // TODO: Add desired properties to the request body.
     *     },
    ...
    get(params: any, options: MethodOptions | BodyResponseCallback<Schema$VariantSet>, callback?: BodyResponseCallback<Schema$VariantSet>): void;
    /**
    ...
    patch(params: any, options: MethodOptions | BodyResponseCallback<Schema$VariantSet>, callback?: BodyResponseCallback<Schema$VariantSet>): void;
    /**
     ...
     * @return {object} Request object
     */
    search(params: any, options?: MethodOptions): AxiosPromise<Schema$SearchVariantSetsResponse>;
    search(params: any, options: MethodOptions | BodyResponseCallback<Schema$SearchVariantSetsResponse>, callback?: BodyResponseCallback<Schema$SearchVariantSetsResponse>): void;
}
