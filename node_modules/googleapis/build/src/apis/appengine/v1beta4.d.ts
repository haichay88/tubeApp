...
export declare class Resource$Apps$Modules {
    root: Appengine;
    ...
    get(params: any, options: MethodOptions | BodyResponseCallback<Schema$Module>, callback?: BodyResponseCallback<Schema$Module>): void;
    /**
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$ListModulesResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$ListModulesResponse>, callback?: BodyResponseCallback<Schema$ListModulesResponse>): void;
    /**
...
export declare class Resource$Apps$Modules$Versions {
    root: Appengine;
...
export declare class Resource$Apps$Modules$Versions$Instances {
    root: Appengine;
    constructor(root: Appengine);
    getRoot(): Appengine;
    /**
