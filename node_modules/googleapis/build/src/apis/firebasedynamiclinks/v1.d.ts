...
export declare class Resource$Shortlinks {
     ...
     */
    create(params: any, options?: MethodOptions): AxiosPromise<Schema$CreateShortDynamicLinkResponse>;
    create(params: any, options: MethodOptions | BodyResponseCallback<Schema$CreateShortDynamicLinkResponse>, callback?: BodyResponseCallback<Schema$CreateShortDynamicLinkResponse>): void;
}
export declare class Resource$V1 {
    root: Firebasedynamiclinks;
    constructor(root: Firebasedynamiclinks);
    getRoot(): Firebasedynamiclinks;
    /**
     ...
     * @return {object} Request object
     */
    getLinkStats(params: any, options?: MethodOptions): AxiosPromise<Schema$DynamicLinkStats>;
    getLinkStats(params: any, options: MethodOptions | BodyResponseCallback<Schema$DynamicLinkStats>, callback?: BodyResponseCallback<Schema$DynamicLinkStats>): void;
    /**
     ...
     * @return {object} Request object
     */
    installAttribution(params: any, options?: MethodOptions): AxiosPromise<Schema$GetIosPostInstallAttributionResponse>;
    installAttribution(params: any, options: MethodOptions | BodyResponseCallback<Schema$GetIosPostInstallAttributionResponse>, callback?: BodyResponseCallback<Schema$GetIosPostInstallAttributionResponse>): void;
}
