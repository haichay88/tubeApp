 ...
 */
export declare class Groupsmigration {
...
export declare class Resource$Archive {
    ...
    insert(params: any, options: MethodOptions | BodyResponseCallback<Schema$Groups>, callback?: BodyResponseCallback<Schema$Groups>): void;
}
