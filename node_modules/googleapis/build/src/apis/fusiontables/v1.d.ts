...
export interface Schema$StyleFunction {
     ...
     * &quot;fusiontables#gradient&quot; if the styling of the row is to be based
     * on applying the gradient function on the column value; or
...
export interface Schema$Task {
     ...
     * the table. ADD_ROWS &quot;Adds one or more rows to a table. Includes
...
export declare class Resource$Template {
    ...
    update(params: any, options: MethodOptions | BodyResponseCallback<Schema$Template>, callback?: BodyResponseCallback<Schema$Template>): void;
}
