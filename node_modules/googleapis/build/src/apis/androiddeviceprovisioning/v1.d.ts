...
export declare class Resource$Partners$Devices {
     ...
     * @return {object} Request object
     */
    unclaimAsync(params: any, options?: MethodOptions): AxiosPromise<Schema$Operation>;
    unclaimAsync(params: any, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback?: BodyResponseCallback<Schema$Operation>): void;
    /**
     ...
     * @return {object} Request object
     */
    updateMetadataAsync(params: any, options?: MethodOptions): AxiosPromise<Schema$Operation>;
    updateMetadataAsync(params: any, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback?: BodyResponseCallback<Schema$Operation>): void;
}
