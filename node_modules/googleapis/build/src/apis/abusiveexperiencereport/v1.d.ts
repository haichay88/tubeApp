 ...
 */
export declare class Abusiveexperiencereport {
...
export declare class Resource$Sites {
     ...
     */
    get(params: any, options?: MethodOptions): AxiosPromise<Schema$SiteSummaryResponse>;
    get(params: any, options: MethodOptions | BodyResponseCallback<Schema$SiteSummaryResponse>, callback?: BodyResponseCallback<Schema$SiteSummaryResponse>): void;
}
export declare class Resource$Violatingsites {
    root: Abusiveexperiencereport;
    constructor(root: Abusiveexperiencereport);
    getRoot(): Abusiveexperiencereport;
    /**
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$ViolatingSitesResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$ViolatingSitesResponse>, callback?: BodyResponseCallback<Schema$ViolatingSitesResponse>): void;
}
