...
export interface Schema$File {
     ...
     * concatenated extensions, such as &quot;tar.gz&quot;. This is only available
     * for files with binary content in Drive. This is automatically updated when
     * the name field changes, however it is not cleared if the new name does not
     ...
     * with a Google Doc MIME type, the uploaded content will be imported if
     ...
     * requests must use the addParents and removeParents parameters to modify the
     * parents list.
     */
    parents: string[];
    /**
...
export declare class Resource$Comments {
    ...
    create(params: any, options: MethodOptions | BodyResponseCallback<Schema$Comment>, callback?: BodyResponseCallback<Schema$Comment>): void;
    /**
...
export declare class Resource$Files {
    ...
    /**
     * drive.files.copy
     * @desc Creates a copy of a file and applies any requested updates with patch
     * semantics.
    ...
    /**
     * drive.files.delete
     * @desc Permanently deletes a file owned by the user without moving it to the
...
export declare class Resource$Permissions {
    ...
    create(params: any, options: MethodOptions | BodyResponseCallback<Schema$Permission>, callback?: BodyResponseCallback<Schema$Permission>): void;
    /**
...
export declare class Resource$Replies {
    ...
    create(params: any, options: MethodOptions | BodyResponseCallback<Schema$Reply>, callback?: BodyResponseCallback<Schema$Reply>): void;
    /**
    ...
    get(params: any, options: MethodOptions | BodyResponseCallback<Schema$Reply>, callback?: BodyResponseCallback<Schema$Reply>): void;
    /**
     * drive.replies.list
    ...
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$ReplyList>, callback?: BodyResponseCallback<Schema$ReplyList>): void;
    /**
    ...
    update(params: any, options: MethodOptions | BodyResponseCallback<Schema$Reply>, callback?: BodyResponseCallback<Schema$Reply>): void;
}
...
export declare class Resource$Teamdrives {
    ...
    create(params: any, options: MethodOptions | BodyResponseCallback<Schema$TeamDrive>, callback?: BodyResponseCallback<Schema$TeamDrive>): void;
    /**
