...
export interface Schema$Person {
     ...
     * 21 or older. Age is determined from the user&#39;s birthday using Western
     * age reckoning.
     */
    ageRange: any;
    /**
...
export declare class Resource$Activities {
     ...
     * @return {object} Request object
     */
    search(params: any, options?: MethodOptions): AxiosPromise<Schema$ActivityFeed>;
    search(params: any, options: MethodOptions | BodyResponseCallback<Schema$ActivityFeed>, callback?: BodyResponseCallback<Schema$ActivityFeed>): void;
}
...
export declare class Resource$People {
     ...
     * @return {object} Request object
     */
    search(params: any, options?: MethodOptions): AxiosPromise<Schema$PeopleFeed>;
    search(params: any, options: MethodOptions | BodyResponseCallback<Schema$PeopleFeed>, callback?: BodyResponseCallback<Schema$PeopleFeed>): void;
}
