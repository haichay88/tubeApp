 ...
 */
export declare class Searchconsole {
...
export declare class Resource$Urltestingtools$Mobilefriendlytest {
     ...
     */
    run(params: any, options?: MethodOptions): AxiosPromise<Schema$RunMobileFriendlyTestResponse>;
    run(params: any, options: MethodOptions | BodyResponseCallback<Schema$RunMobileFriendlyTestResponse>, callback?: BodyResponseCallback<Schema$RunMobileFriendlyTestResponse>): void;
}
