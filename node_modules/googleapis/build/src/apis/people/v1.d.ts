...
export interface Schema$Name {
     ...
     * the locale specified by the viewer&#39;s account or the `Accept-Language`
     * HTTP header.
     */
...
export declare class Resource$Contactgroups {
    root: People;
     ...
     */
    batchGet(params: any, options?: MethodOptions): AxiosPromise<Schema$BatchGetContactGroupsResponse>;
    batchGet(params: any, options: MethodOptions | BodyResponseCallback<Schema$BatchGetContactGroupsResponse>, callback?: BodyResponseCallback<Schema$BatchGetContactGroupsResponse>): void;
    /**
     ...
     * @return {object} Request object
     */
    create(params: any, options?: MethodOptions): AxiosPromise<Schema$ContactGroup>;
    create(params: any, options: MethodOptions | BodyResponseCallback<Schema$ContactGroup>, callback?: BodyResponseCallback<Schema$ContactGroup>): void;
    /**
     ...
     * @return {object} Request object
     */
    get(params: any, options?: MethodOptions): AxiosPromise<Schema$ContactGroup>;
    get(params: any, options: MethodOptions | BodyResponseCallback<Schema$ContactGroup>, callback?: BodyResponseCallback<Schema$ContactGroup>): void;
    /**
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$ListContactGroupsResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$ListContactGroupsResponse>, callback?: BodyResponseCallback<Schema$ListContactGroupsResponse>): void;
    /**
     ...
     * @return {object} Request object
     */
    update(params: any, options?: MethodOptions): AxiosPromise<Schema$ContactGroup>;
    update(params: any, options: MethodOptions | BodyResponseCallback<Schema$ContactGroup>, callback?: BodyResponseCallback<Schema$ContactGroup>): void;
}
export declare class Resource$Contactgroups$Members {
    root: People;
    constructor(root: People);
    getRoot(): People;
    /**
     ...
     * @return {object} Request object
     */
    modify(params: any, options?: MethodOptions): AxiosPromise<Schema$ModifyContactGroupMembersResponse>;
    modify(params: any, options: MethodOptions | BodyResponseCallback<Schema$ModifyContactGroupMembersResponse>, callback?: BodyResponseCallback<Schema$ModifyContactGroupMembersResponse>): void;
}
export declare class Resource$People {
    root: People;
     ...
     * @return {object} Request object
     */
    createContact(params: any, options?: MethodOptions): AxiosPromise<Schema$Person>;
    createContact(params: any, options: MethodOptions | BodyResponseCallback<Schema$Person>, callback?: BodyResponseCallback<Schema$Person>): void;
    /**
     ...
     * @return {object} Request object
     */
    deleteContact(params: any, options?: MethodOptions): AxiosPromise<Schema$Empty>;
    deleteContact(params: any, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback?: BodyResponseCallback<Schema$Empty>): void;
    /**
     * people.people.get
     * @desc Provides information about a person by specifying a resource name.
     * Use `people/me` to indicate the authenticated user. <br> The request throws
    ...
    get(params: any, options: MethodOptions | BodyResponseCallback<Schema$Person>, callback?: BodyResponseCallback<Schema$Person>): void;
    /**
     * people.people.getBatchGet
     * @desc Provides information about a list of specific people by specifying a
     ...
     * @return {object} Request object
     */
    getBatchGet(params: any, options?: MethodOptions): AxiosPromise<Schema$GetPeopleResponse>;
    getBatchGet(params: any, options: MethodOptions | BodyResponseCallback<Schema$GetPeopleResponse>, callback?: BodyResponseCallback<Schema$GetPeopleResponse>): void;
    /**
     ...
     * `updatePersonFields` is not specified. <br> The request throws a 400 error
     * if `person.metadata.sources` is not specified for the contact to be
     ...
     * @return {object} Request object
     */
    updateContact(params: any, options?: MethodOptions): AxiosPromise<Schema$Person>;
    updateContact(params: any, options: MethodOptions | BodyResponseCallback<Schema$Person>, callback?: BodyResponseCallback<Schema$Person>): void;
}
export declare class Resource$People$Connections {
    root: People;
    constructor(root: People);
    getRoot(): People;
    /**
     ...
     * connected profiles. <br> The request throws a 400 error if 'personFields'
     * is not specified.
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$ListConnectionsResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$ListConnectionsResponse>, callback?: BodyResponseCallback<Schema$ListConnectionsResponse>): void;
}
