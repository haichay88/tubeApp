...
export declare class Resource$Landingpages {
    root: Dfareporting;
    constructor(root: Dfareporting);
    getRoot(): Dfareporting;
    /**
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$LandingPagesListResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$LandingPagesListResponse>, callback?: BodyResponseCallback<Schema$LandingPagesListResponse>): void;
    /**
