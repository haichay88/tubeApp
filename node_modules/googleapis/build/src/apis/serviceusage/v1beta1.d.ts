...
export declare class Resource$Services {
     ...
     * @return {object} Request object
     */
    batchEnable(params: any, options?: MethodOptions): AxiosPromise<Schema$Operation>;
    batchEnable(params: any, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback?: BodyResponseCallback<Schema$Operation>): void;
    /**
     ...
     * @desc List all services available to the specified project, and the current
