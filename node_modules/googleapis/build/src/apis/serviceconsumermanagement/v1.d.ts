 ...
 */
export declare class Serviceconsumermanagement {
...
export interface Schema$CreateTenancyUnitRequest {
     ...
     * unique across a service. If the tenancy unit already exists for the service
     * and consumer pair, `CreateTenancyUnit` will return the existing tenancy
...
export interface Schema$HttpRule {
     ...
     * rest_collection: &quot;projects.addresses&quot;       };     }  This method
     * has the automatically derived collection name
     * &quot;projects.aggregated&quot;. Because, semantically, this rpc is
     * actually an operation on the &quot;projects.addresses&quot; collection, the
     * `rest_collection` field is configured to override the derived collection
     * name.
     */
...
export interface Schema$TenantProjectConfig {
     ...
     * have been previously created with proper permissions for the caller to
...
export interface Schema$TenantResource {
     ...
     * the form &#39;projects/{number}&#39;. For example
     * &#39;projects/123456&#39;.
     */
    resource: string;
    /**
...
export declare class Resource$Operations {
    ...
    getRoot(): Serviceconsumermanagement;
    /**
...
export declare class Resource$Services {
     ...
     * @return {object} Request object
     */
    search(params: any, options?: MethodOptions): AxiosPromise<Schema$SearchTenancyUnitsResponse>;
    search(params: any, options: MethodOptions | BodyResponseCallback<Schema$SearchTenancyUnitsResponse>, callback?: BodyResponseCallback<Schema$SearchTenancyUnitsResponse>): void;
}
export declare class Resource$Services$Tenancyunits {
    root: Serviceconsumermanagement;
    constructor(root: Serviceconsumermanagement);
    getRoot(): Serviceconsumermanagement;
    /**
     ...
     * first to clean them before you can make another `AddTenantProject` with the
     * same tag. Operation<response: Empty>.
     ...
     * @return {object} Request object
     */
    addProject(params: any, options?: MethodOptions): AxiosPromise<Schema$Operation>;
    addProject(params: any, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback?: BodyResponseCallback<Schema$Operation>): void;
    /**
     ...
     * @return {object} Request object
     */
    create(params: any, options?: MethodOptions): AxiosPromise<Schema$TenancyUnit>;
    create(params: any, options: MethodOptions | BodyResponseCallback<Schema$TenancyUnit>, callback?: BodyResponseCallback<Schema$TenancyUnit>): void;
    /**
     ...
     * @desc Find the tenancy unit for a service and consumer. This method should
     * not be used in producers' runtime path, for example finding the tenant
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$ListTenancyUnitsResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$ListTenancyUnitsResponse>, callback?: BodyResponseCallback<Schema$ListTenancyUnitsResponse>): void;
    /**
     * serviceconsumermanagement.services.tenancyUnits.removeProject
     * @desc Removes specified project resource identified by tenant resource tag.
     ...
     * method fails. Operation<response: Empty>.
     ...
     * @return {object} Request object
     */
    removeProject(params: any, options?: MethodOptions): AxiosPromise<Schema$Operation>;
    removeProject(params: any, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback?: BodyResponseCallback<Schema$Operation>): void;
}
