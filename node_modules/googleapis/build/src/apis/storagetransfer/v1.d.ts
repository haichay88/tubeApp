 ...
 */
export declare class Storagetransfer {
...
export declare class Resource$Googleserviceaccounts {
    root: Storagetransfer;
    constructor(root: Storagetransfer);
    getRoot(): Storagetransfer;
    /**
     ...
     */
    get(params: any, options?: MethodOptions): AxiosPromise<Schema$GoogleServiceAccount>;
    get(params: any, options: MethodOptions | BodyResponseCallback<Schema$GoogleServiceAccount>, callback?: BodyResponseCallback<Schema$GoogleServiceAccount>): void;
}
export declare class Resource$Transferjobs {
    root: Storagetransfer;
    constructor(root: Storagetransfer);
    getRoot(): Storagetransfer;
    /**
     ...
     * @return {object} Request object
     */
    create(params: any, options?: MethodOptions): AxiosPromise<Schema$TransferJob>;
    create(params: any, options: MethodOptions | BodyResponseCallback<Schema$TransferJob>, callback?: BodyResponseCallback<Schema$TransferJob>): void;
    /**
    ...
    get(params: any, options: MethodOptions | BodyResponseCallback<Schema$TransferJob>, callback?: BodyResponseCallback<Schema$TransferJob>): void;
    /**
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$ListTransferJobsResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$ListTransferJobsResponse>, callback?: BodyResponseCallback<Schema$ListTransferJobsResponse>): void;
    /**
     ...
     * @return {object} Request object
     */
    patch(params: any, options?: MethodOptions): AxiosPromise<Schema$TransferJob>;
    patch(params: any, options: MethodOptions | BodyResponseCallback<Schema$TransferJob>, callback?: BodyResponseCallback<Schema$TransferJob>): void;
}
export declare class Resource$Transferoperations {
    root: Storagetransfer;
    constructor(root: Storagetransfer);
    getRoot(): Storagetransfer;
    /**
    ...
    pause(params: any, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback?: BodyResponseCallback<Schema$Empty>): void;
    /**
    ...
    resume(params: any, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback?: BodyResponseCallback<Schema$Empty>): void;
}
