 ...
 */
export declare class Customsearch {
...
export declare class Resource$Cse {
    ...
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$Search>, callback?: BodyResponseCallback<Schema$Search>): void;
}
export declare class Resource$Cse$Siterestrict {
    root: Customsearch;
    constructor(root: Customsearch);
    getRoot(): Customsearch;
    /**
