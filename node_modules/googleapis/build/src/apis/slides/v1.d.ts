...
export declare class Resource$Presentations {
    root: Slides;
     ...
     */
    batchUpdate(params: any, options?: MethodOptions): AxiosPromise<Schema$BatchUpdatePresentationResponse>;
    batchUpdate(params: any, options: MethodOptions | BodyResponseCallback<Schema$BatchUpdatePresentationResponse>, callback?: BodyResponseCallback<Schema$BatchUpdatePresentationResponse>): void;
    /**
     ...
     * @return {object} Request object
     */
    create(params: any, options?: MethodOptions): AxiosPromise<Schema$Presentation>;
    create(params: any, options: MethodOptions | BodyResponseCallback<Schema$Presentation>, callback?: BodyResponseCallback<Schema$Presentation>): void;
    /**
    ...
    get(params: any, options: MethodOptions | BodyResponseCallback<Schema$Presentation>, callback?: BodyResponseCallback<Schema$Presentation>): void;
}
export declare class Resource$Presentations$Pages {
    root: Slides;
    constructor(root: Slides);
    getRoot(): Slides;
    /**
     ...
     * @return {object} Request object
     */
    getThumbnail(params: any, options?: MethodOptions): AxiosPromise<Schema$Thumbnail>;
    getThumbnail(params: any, options: MethodOptions | BodyResponseCallback<Schema$Thumbnail>, callback?: BodyResponseCallback<Schema$Thumbnail>): void;
}
