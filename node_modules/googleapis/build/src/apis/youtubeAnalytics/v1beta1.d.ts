 ...
 */
export declare class Youtubeanalytics {
...
export declare class Resource$Groupitems {
    root: Youtubeanalytics;
    constructor(root: Youtubeanalytics);
    getRoot(): Youtubeanalytics;
    /**
    ...
    insert(params: any, options: MethodOptions | BodyResponseCallback<Schema$GroupItem>, callback?: BodyResponseCallback<Schema$GroupItem>): void;
    /**
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$GroupItemListResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$GroupItemListResponse>, callback?: BodyResponseCallback<Schema$GroupItemListResponse>): void;
}
export declare class Resource$Groups {
     ...
     * @desc Returns a collection of groups that match the API request parameters.
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$GroupListResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$GroupListResponse>, callback?: BodyResponseCallback<Schema$GroupListResponse>): void;
    /**
...
export declare class Resource$Reports {
    ...
    query(params: any, options: MethodOptions | BodyResponseCallback<Schema$ResultTable>, callback?: BodyResponseCallback<Schema$ResultTable>): void;
}
