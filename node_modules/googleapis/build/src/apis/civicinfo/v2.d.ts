 ...
 */
export declare class Civicinfo {
...
export interface Schema$Candidate {
     ...
     * of candidate at the bottom of the ticket. e.g. &quot;Mitt Romney / Paul
     * Ryan&quot;
     */
    name: string;
    /**
...
export interface Schema$Contest {
    ...
    sources: Schema$Source[];
    /**
     * &quot;Yes&quot; or &quot;No&quot; depending on whether this a contest being
     * held outside the normal election cycle.
     */
    special: string;
    /**
...
export interface Schema$GeographicDivision {
     ...
     * list.  For example, if this division&#39;s OCD ID is
...
export declare class Resource$Divisions {
    root: Civicinfo;
     ...
     */
    search(params: any, options?: MethodOptions): AxiosPromise<Schema$DivisionSearchResponse>;
    search(params: any, options: MethodOptions | BodyResponseCallback<Schema$DivisionSearchResponse>, callback?: BodyResponseCallback<Schema$DivisionSearchResponse>): void;
}
export declare class Resource$Elections {
    root: Civicinfo;
    constructor(root: Civicinfo);
    getRoot(): Civicinfo;
    /**
     ...
     * @return {object} Request object
     */
    electionQuery(params: any, options?: MethodOptions): AxiosPromise<Schema$ElectionsQueryResponse>;
    electionQuery(params: any, options: MethodOptions | BodyResponseCallback<Schema$ElectionsQueryResponse>, callback?: BodyResponseCallback<Schema$ElectionsQueryResponse>): void;
    /**
     ...
     * @return {object} Request object
     */
    voterInfoQuery(params: any, options?: MethodOptions): AxiosPromise<Schema$VoterInfoResponse>;
    voterInfoQuery(params: any, options: MethodOptions | BodyResponseCallback<Schema$VoterInfoResponse>, callback?: BodyResponseCallback<Schema$VoterInfoResponse>): void;
}
export declare class Resource$Representatives {
    root: Civicinfo;
    constructor(root: Civicinfo);
    getRoot(): Civicinfo;
    /**
     ...
     * @return {object} Request object
     */
    representativeInfoByAddress(params: any, options?: MethodOptions): AxiosPromise<Schema$RepresentativeInfoResponse>;
    representativeInfoByAddress(params: any, options: MethodOptions | BodyResponseCallback<Schema$RepresentativeInfoResponse>, callback?: BodyResponseCallback<Schema$RepresentativeInfoResponse>): void;
    /**
     ...
     * @return {object} Request object
     */
    representativeInfoByDivision(params: any, options?: MethodOptions): AxiosPromise<Schema$RepresentativeInfoData>;
    representativeInfoByDivision(params: any, options: MethodOptions | BodyResponseCallback<Schema$RepresentativeInfoData>, callback?: BodyResponseCallback<Schema$RepresentativeInfoData>): void;
}
