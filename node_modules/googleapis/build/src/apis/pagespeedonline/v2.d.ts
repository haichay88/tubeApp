...
export declare class Resource$Pagespeedapi {
     ...
     */
    runpagespeed(params: any, options?: MethodOptions): AxiosPromise<Schema$Result>;
    runpagespeed(params: any, options: MethodOptions | BodyResponseCallback<Schema$Result>, callback?: BodyResponseCallback<Schema$Result>): void;
}
