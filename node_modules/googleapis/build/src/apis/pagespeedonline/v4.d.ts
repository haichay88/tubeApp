 ...
 */
export declare class Pagespeedonline {
...
export declare class Resource$Pagespeedapi {
     ...
     */
    runpagespeed(params: any, options?: MethodOptions): AxiosPromise<Schema$PagespeedApiPagespeedResponseV4>;
    runpagespeed(params: any, options: MethodOptions | BodyResponseCallback<Schema$PagespeedApiPagespeedResponseV4>, callback?: BodyResponseCallback<Schema$PagespeedApiPagespeedResponseV4>): void;
}
