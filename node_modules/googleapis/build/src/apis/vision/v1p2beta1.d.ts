...
export declare class Resource$Files {
     ...
     * @desc Run async image detection and annotation for a list of generic files
     * (e.g. PDF) which may contain multiple pages and multiple images per page.
     ...
     */
    asyncBatchAnnotate(params: any, options?: MethodOptions): AxiosPromise<Schema$Operation>;
    asyncBatchAnnotate(params: any, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback?: BodyResponseCallback<Schema$Operation>): void;
}
export declare class Resource$Images {
    root: Vision;
    constructor(root: Vision);
    getRoot(): Vision;
    /**
     ...
     * @return {object} Request object
     */
    annotate(params: any, options?: MethodOptions): AxiosPromise<Schema$GoogleCloudVisionV1p2beta1BatchAnnotateImagesResponse>;
    annotate(params: any, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudVisionV1p2beta1BatchAnnotateImagesResponse>, callback?: BodyResponseCallback<Schema$GoogleCloudVisionV1p2beta1BatchAnnotateImagesResponse>): void;
}
