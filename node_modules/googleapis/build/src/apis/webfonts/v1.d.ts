...
export declare class Resource$Webfonts {
    root: Webfonts;
    ...
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$WebfontList>, callback?: BodyResponseCallback<Schema$WebfontList>): void;
}
