 ...
 */
export declare class Streetviewpublish {
...
export declare class Resource$Photo {
    root: Streetviewpublish;
    constructor(root: Streetviewpublish);
    getRoot(): Streetviewpublish;
    /**
    ...
    create(params: any, options: MethodOptions | BodyResponseCallback<Schema$Photo>, callback?: BodyResponseCallback<Schema$Photo>): void;
    /**
    ...
    get(params: any, options: MethodOptions | BodyResponseCallback<Schema$Photo>, callback?: BodyResponseCallback<Schema$Photo>): void;
    /**
     ...
     * @return {object} Request object
     */
    startUpload(params: any, options?: MethodOptions): AxiosPromise<Schema$UploadRef>;
    startUpload(params: any, options: MethodOptions | BodyResponseCallback<Schema$UploadRef>, callback?: BodyResponseCallback<Schema$UploadRef>): void;
    /**
    ...
    update(params: any, options: MethodOptions | BodyResponseCallback<Schema$Photo>, callback?: BodyResponseCallback<Schema$Photo>): void;
}
export declare class Resource$Photos {
    root: Streetviewpublish;
    constructor(root: Streetviewpublish);
    getRoot(): Streetviewpublish;
    /**
     ...
     * @return {object} Request object
     */
    batchDelete(params: any, options?: MethodOptions): AxiosPromise<Schema$BatchDeletePhotosResponse>;
    batchDelete(params: any, options: MethodOptions | BodyResponseCallback<Schema$BatchDeletePhotosResponse>, callback?: BodyResponseCallback<Schema$BatchDeletePhotosResponse>): void;
    /**
     ...
     * @return {object} Request object
     */
    batchGet(params: any, options?: MethodOptions): AxiosPromise<Schema$BatchGetPhotosResponse>;
    batchGet(params: any, options: MethodOptions | BodyResponseCallback<Schema$BatchGetPhotosResponse>, callback?: BodyResponseCallback<Schema$BatchGetPhotosResponse>): void;
    /**
     ...
     * @return {object} Request object
     */
    batchUpdate(params: any, options?: MethodOptions): AxiosPromise<Schema$BatchUpdatePhotosResponse>;
    batchUpdate(params: any, options: MethodOptions | BodyResponseCallback<Schema$BatchUpdatePhotosResponse>, callback?: BodyResponseCallback<Schema$BatchUpdatePhotosResponse>): void;
    /**
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$ListPhotosResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$ListPhotosResponse>, callback?: BodyResponseCallback<Schema$ListPhotosResponse>): void;
}
