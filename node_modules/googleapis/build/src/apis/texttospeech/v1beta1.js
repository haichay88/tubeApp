...
var Resource$Text = /** @class */ (function () {
    ...
    Resource$Text.prototype.synthesize = function (params, options, callback) {
...
exports.Resource$Text = Resource$Text;
var Resource$Voices = /** @class */ (function () {
    ...
    Resource$Voices.prototype.list = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
...
exports.Resource$Voices = Resource$Voices;
