...
export declare class Resource$Entities {
    root: Kgsearch;
     ...
     */
    search(params: any, options?: MethodOptions): AxiosPromise<Schema$SearchResponse>;
    search(params: any, options: MethodOptions | BodyResponseCallback<Schema$SearchResponse>, callback?: BodyResponseCallback<Schema$SearchResponse>): void;
}
