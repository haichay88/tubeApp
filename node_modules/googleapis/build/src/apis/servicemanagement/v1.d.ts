...
/**
 * Defines the Media configuration for a service in case of a download. Use this
 * only for Scotty Requests. Do not use this for media support using Bytestream,
 * add instead [][google.bytestream.RestByteStream] as an API to your
...
export interface Schema$MediaDownload {
    ...
    enabled: boolean;
    /**
     * Optional maximum acceptable size for direct download. The size is specified
     * in bytes.
     */
...
/**
 * Defines the Media configuration for a service in case of an upload. Use this
 * only for Scotty Requests. Do not use this for media support using Bytestream,
 * add instead [][google.bytestream.RestByteStream] as an API to your
 * configuration for Bytestream methods.
 */
 ...
 * = &quot;/v2/{resource=**}&quot;;       }     }  Example of a mixin
 * configuration:      apis:     - name: google.storage.v2.Storage       mixins:
 ...
 * documentation and annotations as follows:      service Storage {       // Get
 * the underlying ACL object.       rpc GetAcl(GetAclRequest) returns (Acl) {
 * option (google.api.http).get = &quot;/v2/{resource=**}:getAcl&quot;;       }
 * ...     }  Note how the version in the path pattern changed from `v1` to
 * `v2`.  If the `root` field in the mixin is specified, it should be a relative
 * path under which inherited HTTP paths are placed. Example:      apis:     -
 * name: google.storage.v2.Storage       mixins:       - name:
 * google.acl.v1.AccessControl         root: acls  This implies the following
 * inherited HTTP annotation:      service Storage {       // Get the underlying
...
export interface Schema$Monitoring {
     ...
     * There can be multiple consumer destinations, each one must have a different
     ...
     * There can be multiple producer destinations, each one must have a different
     * monitored resource type. A metric can be used in at most one producer
     * destination.
     */
 ...
 * scope specifications should be fairly coarse grained; a user will need to see
 * and understand the text description of what your scope means.  In most cases:
 * use one or at most two OAuth scopes for an entire family of products. If your
...
export interface Schema$Page {
     ...
     * include {path} ==&amp;#41;&lt;/code&gt; to include content from a Markdown
     * file.
     */
    content: string;
    /**
     ...
     * example: &lt;pre&gt;&lt;code&gt;pages: - name: Tutorial   content:
     * &amp;#40;== include tutorial.md ==&amp;#41;   subpages:   - name: Java
     * content: &amp;#40;== include tutorial_java.md ==&amp;#41;
     * &lt;/code&gt;&lt;/pre&gt; You can reference `Java` page using Markdown
 ...
 * The quota configuration works this way: - The service configuration defines a
 * set of metrics. - For API calls, the quota.metric_rules maps methods to
 * metrics with   corresponding costs. - The quota.limits defines limits on the
...
export interface Schema$QuotaLimit {
     ...
     * duration &quot;1d&quot;, in a billable group; it is invalid on any other
     ...
     * well as &#39;-&#39;.  The maximum length of the limit name is 64
     * characters.
     */
    name: string;
    /**
...
export interface Schema$Rollout {
     ...
     * and &#39;-&#39; are allowed.  If not specified by client, the server will
     * generate one. The generated id will have the form of
...
export interface Schema$SystemParameters {
     ...
     * for all methods      system_parameters       rules:         - selector:
 ...
 * this rule to configure unregistered calls for the service. Unregistered calls
 * are calls that do not contain consumer project identity. (Example: calls that
 * do not contain an API key). By default, API methods do not allow unregistered
 ...
 * API that wants to allow unregistered calls for entire service.      usage:
 * rules:       - selector: &quot;*&quot;         allow_unregistered_calls: true
 * Example of a method that wants to allow unregistered calls.      usage:
 * rules:       - selector:
 * &quot;google.example.library.v1.LibraryService.CreateBook&quot;
...
export declare class Resource$Services {
     ...
     * @desc Deletes a managed service. This method will change the service to the
     * `Soft-Delete` state for 30 days. Within this period, service producers may
     * call UndeleteService to restore the service. After 30 days, the service
     * will be permanently deleted.  Operation<response: google.protobuf.Empty>
     ...
     * @desc Disables a service for a project, so it can no longer be be used for
     * the project. It prevents accidental usage that may cause unexpected billing
     * charges or security leaks.  Operation<response: DisableServiceResponse>
    ...
    disable(params: any, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback?: BodyResponseCallback<Schema$Operation>): void;
    /**
    ...
    enable(params: any, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback?: BodyResponseCallback<Schema$Operation>): void;
    /**
     ...
     * @return {object} Request object
     */
    generateConfigReport(params: any, options?: MethodOptions): AxiosPromise<Schema$GenerateConfigReportResponse>;
    generateConfigReport(params: any, options: MethodOptions | BodyResponseCallback<Schema$GenerateConfigReportResponse>, callback?: BodyResponseCallback<Schema$GenerateConfigReportResponse>): void;
    /**
     * servicemanagement.services.get
     * @desc Gets a managed service. Authentication is required unless the service
     * is public.
     ...
     * @return {object} Request object
     */
    get(params: any, options?: MethodOptions): AxiosPromise<Schema$ManagedService>;
    get(params: any, options: MethodOptions | BodyResponseCallback<Schema$ManagedService>, callback?: BodyResponseCallback<Schema$ManagedService>): void;
    /**
    ...
    getConfig(params: any, options: MethodOptions | BodyResponseCallback<Schema$Service>, callback?: BodyResponseCallback<Schema$Service>): void;
    /**
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$ListServicesResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$ListServicesResponse>, callback?: BodyResponseCallback<Schema$ListServicesResponse>): void;
    /**
     ...
     * @desc Revives a previously deleted managed service. The method restores the
     ...
     * days.  Operation<response: UndeleteServiceResponse>
     ...
     * @return {object} Request object
     */
    undelete(params: any, options?: MethodOptions): AxiosPromise<Schema$Operation>;
    undelete(params: any, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback?: BodyResponseCallback<Schema$Operation>): void;
}
export declare class Resource$Services$Configs {
    root: Servicemanagement;
    constructor(root: Servicemanagement);
    getRoot(): Servicemanagement;
    /**
    ...
    create(params: any, options: MethodOptions | BodyResponseCallback<Schema$Service>, callback?: BodyResponseCallback<Schema$Service>): void;
    /**
    ...
    get(params: any, options: MethodOptions | BodyResponseCallback<Schema$Service>, callback?: BodyResponseCallback<Schema$Service>): void;
    /**
     * servicemanagement.services.configs.list
     * @desc Lists the history of the service configuration for a managed service,
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$ListServiceConfigsResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$ListServiceConfigsResponse>, callback?: BodyResponseCallback<Schema$ListServiceConfigsResponse>): void;
    /**
    ...
    submit(params: any, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback?: BodyResponseCallback<Schema$Operation>): void;
}
export declare class Resource$Services$Consumers {
    root: Servicemanagement;
    constructor(root: Servicemanagement);
    getRoot(): Servicemanagement;
    /**
...
export declare class Resource$Services$Rollouts {
    root: Servicemanagement;
    constructor(root: Servicemanagement);
    getRoot(): Servicemanagement;
    /**
    ...
    get(params: any, options: MethodOptions | BodyResponseCallback<Schema$Rollout>, callback?: BodyResponseCallback<Schema$Rollout>): void;
    /**
     * servicemanagement.services.rollouts.list
     * @desc Lists the history of the service configuration rollouts for a managed
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$ListServiceRolloutsResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$ListServiceRolloutsResponse>, callback?: BodyResponseCallback<Schema$ListServiceRolloutsResponse>): void;
}
