...
export declare class Resource$Pools {
    root: Replicapool;
    ...
    get(params: any, options: MethodOptions | BodyResponseCallback<Schema$Pool>, callback?: BodyResponseCallback<Schema$Pool>): void;
    /**
    ...
    insert(params: any, options: MethodOptions | BodyResponseCallback<Schema$Pool>, callback?: BodyResponseCallback<Schema$Pool>): void;
    /**
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$PoolsListResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$PoolsListResponse>, callback?: BodyResponseCallback<Schema$PoolsListResponse>): void;
    /**
    ...
    resize(params: any, options: MethodOptions | BodyResponseCallback<Schema$Pool>, callback?: BodyResponseCallback<Schema$Pool>): void;
    /**
    ...
    updatetemplate(params: any, options: MethodOptions | BodyResponseCallback<void>, callback?: BodyResponseCallback<void>): void;
}
export declare class Resource$Replicas {
    root: Replicapool;
    constructor(root: Replicapool);
    getRoot(): Replicapool;
    /**
    ...
    delete(params: any, options: MethodOptions | BodyResponseCallback<Schema$Replica>, callback?: BodyResponseCallback<Schema$Replica>): void;
    /**
    ...
    get(params: any, options: MethodOptions | BodyResponseCallback<Schema$Replica>, callback?: BodyResponseCallback<Schema$Replica>): void;
    /**
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$ReplicasListResponse>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$ReplicasListResponse>, callback?: BodyResponseCallback<Schema$ReplicasListResponse>): void;
    /**
    ...
    restart(params: any, options: MethodOptions | BodyResponseCallback<Schema$Replica>, callback?: BodyResponseCallback<Schema$Replica>): void;
}
