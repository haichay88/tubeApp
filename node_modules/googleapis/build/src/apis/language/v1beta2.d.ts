...
export interface Schema$DependencyEdge {
     ...
     * of the token which has an arc going to this token. The index is the
...
export declare class Resource$Documents {
    root: Language;
    constructor(root: Language);
    getRoot(): Language;
    /**
     * language.documents.analyzeEntities
     * @desc Finds named entities (currently proper names and common nouns) in the
     * text along with entity types, salience, mentions for each entity, and other
     * properties.
     ...
     */
    analyzeEntities(params: any, options?: MethodOptions): AxiosPromise<Schema$AnalyzeEntitiesResponse>;
    analyzeEntities(params: any, options: MethodOptions | BodyResponseCallback<Schema$AnalyzeEntitiesResponse>, callback?: BodyResponseCallback<Schema$AnalyzeEntitiesResponse>): void;
    /**
     ...
     * @return {object} Request object
     */
    analyzeEntitySentiment(params: any, options?: MethodOptions): AxiosPromise<Schema$AnalyzeEntitySentimentResponse>;
    analyzeEntitySentiment(params: any, options: MethodOptions | BodyResponseCallback<Schema$AnalyzeEntitySentimentResponse>, callback?: BodyResponseCallback<Schema$AnalyzeEntitySentimentResponse>): void;
    /**
     ...
     * @return {object} Request object
     */
    analyzeSentiment(params: any, options?: MethodOptions): AxiosPromise<Schema$AnalyzeSentimentResponse>;
    analyzeSentiment(params: any, options: MethodOptions | BodyResponseCallback<Schema$AnalyzeSentimentResponse>, callback?: BodyResponseCallback<Schema$AnalyzeSentimentResponse>): void;
    /**
     * language.documents.analyzeSyntax
     * @desc Analyzes the syntax of the text and provides sentence boundaries and
     ...
     * @return {object} Request object
     */
    analyzeSyntax(params: any, options?: MethodOptions): AxiosPromise<Schema$AnalyzeSyntaxResponse>;
    analyzeSyntax(params: any, options: MethodOptions | BodyResponseCallback<Schema$AnalyzeSyntaxResponse>, callback?: BodyResponseCallback<Schema$AnalyzeSyntaxResponse>): void;
    /**
     * language.documents.annotateText
     * @desc A convenience method that provides all syntax, sentiment, entity, and
     ...
     * @return {object} Request object
     */
    annotateText(params: any, options?: MethodOptions): AxiosPromise<Schema$AnnotateTextResponse>;
    annotateText(params: any, options: MethodOptions | BodyResponseCallback<Schema$AnnotateTextResponse>, callback?: BodyResponseCallback<Schema$AnnotateTextResponse>): void;
    /**
     ...
     * @return {object} Request object
     */
    classifyText(params: any, options?: MethodOptions): AxiosPromise<Schema$ClassifyTextResponse>;
    classifyText(params: any, options: MethodOptions | BodyResponseCallback<Schema$ClassifyTextResponse>, callback?: BodyResponseCallback<Schema$ClassifyTextResponse>): void;
}
