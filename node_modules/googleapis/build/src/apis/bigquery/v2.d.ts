...
export interface Schema$JobStatistics2 {
     ...
     * ... &quot;DROP_TABLE&quot;: DROP TABLE query. &quot;CREATE_VIEW&quot;:
     * CREATE [OR REPLACE] VIEW ... AS SELECT ... &quot;DROP_VIEW&quot;: DROP VIEW
     * query.
     */
...
export interface Schema$QueryRequest {
     ...
     * &#39;jobComplete&#39; flag set to false. You can call GetQueryResults() to
     * wait for the query to complete and read the results. The default value is
...
export interface Schema$TimePartitioning {
     ...
     * field. The field must be a top-level TIMESTAMP or DATE field. Its mode must
...
export declare class Resource$Datasets {
     ...
     * @desc Deletes the dataset specified by the datasetId value. Before you can
    ...
    insert(params: any, options: MethodOptions | BodyResponseCallback<Schema$Dataset>, callback?: BodyResponseCallback<Schema$Dataset>): void;
    /**
    ...
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$DatasetList>, callback?: BodyResponseCallback<Schema$DatasetList>): void;
    /**
    ...
    update(params: any, options: MethodOptions | BodyResponseCallback<Schema$Dataset>, callback?: BodyResponseCallback<Schema$Dataset>): void;
}
export declare class Resource$Jobs {
     ...
     * @desc Requests that a job be cancelled. This call will return immediately,
     ...
     * @return {object} Request object
     */
    cancel(params: any, options?: MethodOptions): AxiosPromise<Schema$JobCancelResponse>;
    cancel(params: any, options: MethodOptions | BodyResponseCallback<Schema$JobCancelResponse>, callback?: BodyResponseCallback<Schema$JobCancelResponse>): void;
    /**
     * bigquery.jobs.get
     ...
     * @return {object} Request object
     */
    getQueryResults(params: any, options?: MethodOptions): AxiosPromise<Schema$GetQueryResultsResponse>;
    getQueryResults(params: any, options: MethodOptions | BodyResponseCallback<Schema$GetQueryResultsResponse>, callback?: BodyResponseCallback<Schema$GetQueryResultsResponse>): void;
    /**
    ...
    insert(params: any, options: MethodOptions | BodyResponseCallback<Schema$Job>, callback?: BodyResponseCallback<Schema$Job>): void;
    /**
     * bigquery.jobs.list
     ...
     * Requires the Can View project role, or the Is Owner project role if you set
    ...
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$JobList>, callback?: BodyResponseCallback<Schema$JobList>): void;
    /**
     * bigquery.jobs.query
     * @desc Runs a BigQuery SQL query synchronously and returns query results if
     ...
     * @return {object} Request object
     */
    query(params: any, options?: MethodOptions): AxiosPromise<Schema$QueryResponse>;
    query(params: any, options: MethodOptions | BodyResponseCallback<Schema$QueryResponse>, callback?: BodyResponseCallback<Schema$QueryResponse>): void;
}
export declare class Resource$Projects {
     ...
     * @return {object} Request object
     */
    getServiceAccount(params: any, options?: MethodOptions): AxiosPromise<Schema$GetServiceAccountResponse>;
    getServiceAccount(params: any, options: MethodOptions | BodyResponseCallback<Schema$GetServiceAccountResponse>, callback?: BodyResponseCallback<Schema$GetServiceAccountResponse>): void;
    /**
    ...
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$ProjectList>, callback?: BodyResponseCallback<Schema$ProjectList>): void;
}
export declare class Resource$Tabledata {
    root: Bigquery;
    constructor(root: Bigquery);
    getRoot(): Bigquery;
    /**
     ...
     * @return {object} Request object
     */
    insertAll(params: any, options?: MethodOptions): AxiosPromise<Schema$TableDataInsertAllResponse>;
    insertAll(params: any, options: MethodOptions | BodyResponseCallback<Schema$TableDataInsertAllResponse>, callback?: BodyResponseCallback<Schema$TableDataInsertAllResponse>): void;
    /**
     ...
     * @return {object} Request object
     */
    list(params: any, options?: MethodOptions): AxiosPromise<Schema$TableDataList>;
    list(params: any, options: MethodOptions | BodyResponseCallback<Schema$TableDataList>, callback?: BodyResponseCallback<Schema$TableDataList>): void;
}
export declare class Resource$Tables {
    root: Bigquery;
    constructor(root: Bigquery);
    getRoot(): Bigquery;
    /**
     * bigquery.tables.delete
     * @desc Deletes the table specified by tableId from the dataset. If the table
     ...
     * @desc Updates information in an existing table. The update method replaces
